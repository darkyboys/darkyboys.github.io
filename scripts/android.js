...
//     Added content
if (screen.width < 600){
    // GTG_applyRippleEffect('.project-card', 'rgba(0, 0, 0, 0.5)');
    GTG_applyRippleEffect(".project-card", "rgba(255, 255, 255, 0.15)");
    GTG_applyRippleEffect(".mobile-nav li", "rgba(255, 255, 255, 0.15)");
    GTG_applyRippleEffect("button", "rgba(255, 255, 255, 0.15)");
    GTG_applyRippleEffect(".btn-primary", "rgba(0, 0, 0, 0.25)");
    GTG_applyRippleEffect(".btn", "rgba(255, 255, 255, 0.25)");
    GTG_applyRippleEffect(".opt-link", "rgba(255, 255, 255, 0.25)");
}
